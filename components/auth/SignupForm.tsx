    ...
    >
      <div className="glass-card rounded-3xl p-8 border border-white/[0.08]">
        <div className="mb-8">
          ...
          <p className="text-white/40 text-sm">Join 186,000+ awareness spreaders</p>
        </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl glass border border-white/10 text-white/80 hover:text-white hover:border-white/20 transition-all duration-200 mb-6 disabled:opacity-50 font-medium"
        >
          {googleLoading ? (
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <p className="text-white/20 text-xs">
            ...
            <a href="/terms" className="text-neon-cyan hover:underline">Terms of Service</a>{" "}
            and{" "}
